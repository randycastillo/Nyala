namespace Nyala.Core.Tests
{
    ...
    public class RoverTests
    {
        ...
        {
            var subject = new Rover(5);
            var coordinates = subject.GetCurrentCoordinates();
        ...
        public void ShouldMoveForwardWhenCommandIsF()
        {
            var subject = new Rover(5);
            subject.Command("f");
            subject.GetCurrentCoordinates().Should().Be($"0,1 facing North");
        }
        ...
        [Fact]
        public void ShouldDetectObstacleBeforeMoving()
        {
            var subject = new Rover(5);
